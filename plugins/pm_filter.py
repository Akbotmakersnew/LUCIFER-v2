...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        ...
        btn.insert(0,
            [
                InlineKeyboardButton("JB LINKS", url="https://t.me/jb_links"),
            ]
        )
        btn.insert(1,
            [
                InlineKeyboardButton("🍿 Movie Group 🍿", url="https://t.me/movie_maniac007"),
            ]
        )
        btn.append(
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🔴 Movie Group', url=f'https://t.me/Movie_Maniac007')
            ],[
            InlineKeyboardButton('💀 OWNER 💀', url=f'https://t.me/jb_links')
            ],[
